...
public class CareersElements extends AbstractBasePage {
    ...
    private static final String SELECTED_OPEN_JOBS_LIST = "//div[@class='job-teaser']";
    ...
    protected WebElement getClearFiltersButton() {
        return waitUntilElementToBeVisibleByXpath(CLEAR_FILTERS_BUTTON);
    }

    protected WebElement getBackToPreviousStepSelectingLocationButton() {
        return waitUntilElementToBeVisibleByXpath(BACK_TO_PREVIOUS_STEP_SELECTING_LOCATION);
    }

    protected WebElement getTeamsFilter() {
        return waitUntilElementToBeVisibleByXpath(TEAMS_FILTER);
    }

    protected WebElement getSectionOfTeamsFilter(String option) {
    ...
    protected WebElement getFutureTalentsFilter() {
        return waitUntilElementToBeClickableByXpath(FUTURE_TALENTS_FILTER);
    }

    protected WebElement getSectionOfFutureTalentsFilter(String option) {
    ...
    protected WebElement getNeededOpenJob() {
