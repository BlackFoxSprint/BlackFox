...
public class HomeElements extends AbstractBasePage {
    ...
    public static final String SALE_CATEGORY = "//a[@data-link-name='Sale']";
    ...
    private static final String SELECT_LOCATION_CLOSE_BTN = dataTestId("close-btn");
    private static final String COOKIE_CLOSE_BTN = dataTestId("cookie-banner-close-btn");
    ...
    protected WebElement getCategory(String category) {
